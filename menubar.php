    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">DRS-DEV</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?PHP echo ROOT_URL;?>/index.php">首頁</a></li>
		  ...
		  <?PHP
			...
			if (ckadmin())
			{
				if ( $USER['power'] == '1' )
				{
					echo "<li><a href = '" . ROOT_URL . "/admin/admin.php'>後台管理</a></li>";
				...
				echo "<li><a href = '" . ROOT_URL . "/userlogin.php'>登入</a></li>";
			}
			?>
          </ul>
        </div><!--/.nav-collapse -->
